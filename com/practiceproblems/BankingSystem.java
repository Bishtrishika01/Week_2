...
public class BankingSystem {
    public static void main(String[] args) {
        ...
        savingsAccount.setAccountNumber(678);
        savingsAccount.setHolderName("Rishika Bisht");
        ...
        currentAccount.setAccountNumber(356);
        currentAccount.setHolderName("Geeta Bisht");
